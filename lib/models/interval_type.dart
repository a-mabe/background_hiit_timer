class IntervalType {
  ...
  /// Convert to a Map — used for MediaItem extras and optional persistence.
  ...
  /// Create from a Map (e.g. from MediaItem.extras).
  ...
  @override
  String toString() {
    return 'IntervalType{id: $id, workoutId: $workoutId, time: $time, '
        'name: $name, color: $color, intervalIndex: $intervalIndex, '
        'startSound: $startSound, halfwaySound: $halfwaySound, '
        'countdownSound: $countdownSound, endSound: $endSound}';
  }
}
